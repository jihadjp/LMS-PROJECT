...
function Login() {
  ...
  // ============================================================
  // ১. লগআউট সিঙ্ক্রোনাইজেশন লজিক (অত্যন্ত গুরুত্বপূর্ণ)
  // ============================================================
  useEffect(() => {
    // যখন অ্যাডমিন প্যানেল (Port 8080) থেকে লগআউট করে এখানে আসবে
    const params = new URLSearchParams(location.search);
    if (params.get("logout") === "true" || params.get("session_expired") === "true") {
      // LocalStorage এবং Context দোনোটাই ক্লিয়ার করবে
      logout(); 
      ...
      // ইউআরএল থেকে প্যারামিটার মুছে ফেলা (Clean URL)
      navigate("/login", { replace: true });
    }
  }, [location, logout, navigate]);

  // ============================================================
  // ২. লগইন হ্যান্ডলিং লজিক
  // ============================================================
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success && result.user) {
        // রিঅ্যাক্ট কনটেক্সটে ইউজার ডাটা সেট করা
        setUser(result.user);
        
        const userRole = result.user.role;

        // প্রফেশনাল রোল-বেজড রিডাইরেকশন
          ...
          <div className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl p-10 border border-white/50">
            <form onSubmit={handleLogin} className="space-y-6" autoComplete="off">
              ...
              <div className="flex items-center justify-end">
                <Link to="/forgot-password" class="text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors">
                  Forgot Password?
                </Link>
              </div>
            ...
            {/* সেপারেটর এবং রেজিস্ট্রেশন লিঙ্ক */}
            <div className="mt-10">
